...
/* begin: ../../blocks/link/link.browser.js */
(function(){
modules.define(
    'link',
    ['i-bem__dom', 'jquery'],
...
var Link = BEMDOM.decl(this.name);

provide(Link);
});

}());
/* end: ../../blocks/link/link.browser.js */
/* begin: ../../blocks/link/_download/link_download.browser.js */
(function(){
modules.define(
    'link',
    ['i-bem__dom', 'jquery'],
...
Link.decl({ block : this.name, modName : 'download', modVal : true }, {
...
/* end: ../../blocks/link/_download/link_download.browser.js */
/* begin: ../../blocks/image/image.browser.js */
(function(){
modules.define(
    'image',
    ['i-bem__dom'],
...
/* end: ../../blocks/image/image.browser.js */
    ...
    onSetMod : {
        js : {
            inited : function() {
                ...
                this.submenu && this.submenu.elem('close').click(this.closeModal);

                this.menu = this.findBlockInside('menu');
                this.menuItems = this.findBlocksInside('menu-item') || [];
...
/* begin: ../../blocks/jquery/__niceSelect/jquery__niceSelect.source.browser.js */
(function(){
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
 * @module niceSelect
 */
modules.define( 'jquery__niceSelect', ['jquery'], function(provide, $) {
    require('../../libs/jquery-nice-select/js/jquery.nice-select.js');
provide($);
})

},{"../../libs/jquery-nice-select/js/jquery.nice-select.js":2}],2:[function(require,module,exports){
...
/* begin: ../../libs/bem-forms/common.blocks/checkbox/checkbox.browser.js */
(function(){
...
/* end: ../../libs/bem-forms/common.blocks/checkbox/checkbox.browser.js */
/* begin: ../../blocks/download/download.browser.js */
(function(){
'use strict';

modules.define('download', ['i-bem__dom', 'jquery'], function (provide, BEMDOM, $) {
    provide(BEMDOM.decl(this.name, {
        onSetMod: {
            js: {
                inited: function inited() {
...
/* end: ../../blocks/download/download.browser.js */
/* begin: ../../blocks/adblock/adblock.browser.js */
(function(){
modules.define(
    'adblock',
    ['i-bem__dom', 'jquery'],
...
/* end: ../../blocks/adblock/adblock.browser.js */
...
/* begin: ../../blocks/sticker/sticker.browser.js */
(function(){
modules.define('sticker',
['i-bem__dom', 'jquery'],
function(provide, BEMDOM, $) {
provide(BEMDOM.decl(this.name, {
onSetMod : {
...
},{"../../libs/Swiper/dist/js/swiper.jquery.js":2}],2:[function(require,module,exports){
/**
 * Swiper 3.4.2
...
/* end: ../../blocks/swiper/swiper.source.browser.js */
/* begin: ../../blocks/image-switcher/image-switcher.browser.js */
(function(){
modules.define(
    'image-switcher',
    ['i-bem__dom', 'jquery'],
...
provide(BEMDOM.decl(this.name,
{
    onElemSetMod : {
        'image' : {
            'active' : {
                true : function(elem) {
                    this.delMod(this._activeImage, 'active');
                    this._activeImage = elem;
                }
            }
        }
    },
    ...
    onSetMod : {
        js : {
            inited : function() {
                this.setMod(this.elem('image').first(), 'active', true);
                this._activeImage = this.elem('image', 'active');
                this._interval;
    ...
    _switch: function(index) {
        this.setMod($(this.elem('image')[index]), 'active', true);
    },
...
modules.define( 'jquery__fullpage', ['jquery'], function(provide, $) {
    'use strict';
...
/* begin: ../../blocks/image/_lazy/image_lazy_onDocumentLoaded.browser.js */
(function(){
/**
 * @module image
 */
modules.define('image',
    ['i-bem__dom'],
...
Image.decl({ block : this.name, modName : 'lazy', modVal : 'onDocumentLoaded' },
{
    onSetMod : {
        js : {
            inited : function() {
                ...
                self.domElem.attr('src', self.domElem.attr('data-src'));
            }
        }
    }
});
...
/* end: ../../blocks/image/_lazy/image_lazy_onDocumentLoaded.browser.js */
...
modules.define('header',
    ...
    provide(BEMDOM.decl(this.name, {
        ...
        onSetMod : {
            js : {
                inited : function() {
                    this.findBlockInside('nav-menu-burger').on(
                        { modName : 'modal', modVal : '*' },
                        this._onModal,
                        this
                    )
...
/* begin: ../../blocks/modal/modal.browser.js */
(function(){
...
/* end: ../../blocks/modal/modal.browser.js */
...
/* begin: ../../blocks/international/international.browser.js */
(function(){
modules.define(
'international',
['i-bem__dom', 'jquery__niceSelect'],
function(provide, BEMDOM, $) {
provide(BEMDOM.decl(this.name, {
    onSetMod : {
        js : {
            inited : function() {
                this.select = this.elem('languages');
                ...
                options$.each(function(index, item) {
                    var option$ = $(item);
                    var to = option$.attr('lang');

                    if (option$.hasClass('selected')) { return; };

                    this.bindTo(option$, 'click', function(e) {
...
/* end: ../../blocks/international/international.browser.js */
/* begin: ../../blocks/checkbox-animated/checkbox-animated.browser.js */
(function(){
modules.define(
    'checkbox-animated',
    ['i-bem__dom', 'jquery'],
...
/* end: ../../blocks/checkbox-animated/checkbox-animated.browser.js */
/* begin: ../../blocks/section/section.browser.js */
(function(){
modules.define(
    'section',
    ['i-bem__dom'],
...
provide(BEMDOM.decl(this.name, {
    onSetMod : {
        js : {
            inited : function () {
                this.name = this.getMod('name') || this.getMod('type');
            }
        }
    }
}));
...
/* end: ../../blocks/section/section.browser.js */
    ...
    onSetMod : {
        'js' : {
            'inited' : function() {
                ...
                this.swiper = new Swiper(this.domElem, opts);
            }
        }
    },
...
modules.define('section',
    ...
    function(provide, $, Page, Section) {
         ...
         * @bem
         */
        Section.decl({ block : this.name, modName : 'name', modVal : 'magicDesktop9' },
            {
                ...
                onSetMod : {
                    js : {
                        inited : function() {
                            this.__base.apply(this, arguments);
                            Page.on('afterfpload', function(e, data) {
                                if(data.anchorLink === 'magicDesktop9') {
                                    this.setMod('active-down', true);
                                }

                                if(data.anchorLink === 'footer') {
                                    this.setMod('active-down', true);
                                }
                            }, this);

                            Page.on('fpleave', function (e, data) {
                                if(data.name === 'magicDesktop9' && data.dir === 'up') {
                                    this.delMod('active-down');
                                }
                            }, this);
                        }
                    }
...
modules.define('section',
    ['i-bem__dom', 'page'],
    function(provide, BEMDOM, Page, Section) {
        ...
        Section.decl({ block : this.name, modName : 'type', modVal : 'summary-main' },
            {
                onSetMod : {
                    js : {
                        inited : function() {
                            ...
                            var footer = this.elem('footer');
                            var height = this.domElem.outerHeight();
                            var self = this;
                            if($(window).width() >= 1300 && $(window).height() >= 900) {
                                Page.on('fpleave', function(e, data) {
                                    if (data.index === 1) {
                                        footer.animate({
                                            bottom : height
                            ...
                            Page.on('afterfpload', function () {
                                footer.stop().css('bottom', '')
                            });

                            if (!(window.screen.width > 638 && window.screen.height > 638)) {
                                this.bindTo('go', 'click', function(e) {
                                    e.preventDefault();
                                    $('html, body').animate({
                                        scrollTop : self.domElem.offset().top + self.domElem.height() + 1
                                    }, '1000', 'swing');
                                });
                            }
                        }
...
(function(){
modules.define('page',
    ['i-bem__dom', 'jquery', 'download'],
    function(provide, BEMDOM, $, Download) {
...
provide(BEMDOM.decl(this.name, {
    onSetMod : {
        js : {
            inited : function () {
                ...
                this.modalOrientation = this.findBlockInside('modal-orientation');
                this._header = this.findBlockInside('header');
                var self = this;

                if(IS_IPAD) {
                    this.setMod('is-ipad', true)
                }

                if (this.modalOrientation && isMobile()) {
                ...
                Download.on('downloadClick', function() {
                    self.findBlockInside('submenu').setMod('visible');
                })
            }
        }
    },
    ...
    _checkOrientation : function() {
        if (window.innerHeight < window.innerWidth) {
            this.modalOrientation.show();
        } else {
            this.modalOrientation.hide();
        }
    },
...
/* begin: ../../blocks/modal-orientation/modal-orientation.browser.js */
(function(){
modules.define('modal-orientation',
['i-bem__dom'],
function(provide, BEMDOM) {
...
onSetMod : {
    js : {
        inited : function() {
            ...
            this.button = this.findBlockOn(this.elem('button'), 'button');
            this.showModal = this.showModal;

            this.button.on(
                { modName : 'pressed', modVal : true },
        ...
        js: {
            inited: function() {
                var modal = this.findBlockInside('modal'),
                    ...
                    closeButton = this.findBlockOn(this.elem('close'), 'button'),
                    playButton = this.findBlockOn(this.elem('button'), 'button'),
                    smallVideo = this.findBlockInside({blockName: 'video', modName: 'type', modVal: 'small'});

                    console.log('heeeere', playButton)

                playButton.on('click', function() {
                    modal.setMod('visible', true);
                    $('body').css('overflow', 'visible');

                    smallVideo && smallVideo.delMod('loaded');
                    video.setMod('loaded')
                ...
                closeButton.on('click', function () {
                    ...
                    smallVideo && smallVideo.setMod('loaded');
...
modules.define(
    'page',
    ['i-bem__dom', 'jquery__fullpage', 'next-tick'],
    function(provide, BEMDOM, $, nextTick, Page) {
...
Page.decl({ modName : 'view', modVal : 'site-summary'}, {
        ...
        js : {
            inited : function() {
                ...
                this.elem('fullpage').fullpage({
                    ...
                    afterLoad : this._afterFPLoad.bind(this),
                    fixedElements : '.header_fullpage',
                    scrollBar: !this.hasMod('is-ipad') && !isIEMobileTouchDevice(),
                    scrollingSpeed : 1000,
                    fitToSection: false,
                    easingcss3: "cubic-bezier(0.645, 0.045, 0.355, 1)",
                    bigSectionsDestination : top
                });
                    //this._offset = this._offsetFirstSection();
                    //this._onScroll();
                    //this.bindToDoc('scroll', this._onScroll.bind(this));

                // Init background on two sections
                this._updateBackground();
                // this.bindToDoc('resize', function() {
                //     nextTick(this._updateBackground())
                // }, this)
    ...
    _onFPLeave : function (index, nextIndex, dir) {
        this.currentSection = this.sections[index - 1];
        this.nextSection = this.sections[nextIndex - 1];

        //this.currentSection.elem('go').animate({opacity : 0});
        this.elem('go', 'name', this.currentSection.name).animate({opacity : 0});
        ...
        this.emit('fpleave', {
            ...
            nextName : this.nextSection.name
        });

        if(!this.hasMod('is-ipad') && this.currentSection.hasMod('paralax') && this.nextSection.hasMod('paralax')) {

            this.currentSection.domElem.css({
                'z-index' : this.currentSection.params.fixed ? 3 : 4,
            });

            this.nextSection.domElem.css({
                'z-index' : this.nextSection.params.fixed ? 3 : 4,
            });

            var currentParams = this.currentSection.params;

            var nextParams = this.nextSection.params;

            if(currentParams.fixed) {
                var top = this.currentSection.domElem.outerHeight();
                top = this.dir === 'up' ? top * -1 : top;
                this.currentSection.domElem
                    .stop()
                    .animate({
                        top: top
                    }, 1000, 'easeInOutCubic')

            } else if (nextParams.fixed){
                var top = this.nextSection.domElem.outerHeight();
                top = this.dir === 'down' ? top * -1 : top;
                this.nextSection.domElem
                    .stop()
                    .css('top', top)
                    .animate({
                        top: 0
            ...
            // this.bindToDoc('scroll', this._onParalaxScroll, this);
        }

        this.updateHeader(nextIndex);
    },

    _onParalaxScroll : function (e) {
        var height, offsetTop, scrollTop, delta;
        ...
        if(currentParams.fixed) {
            height = this.nextSection.domElem.outerHeight();
            offsetTop = this.nextSection.domElem.offset().top;
            delta = height - Math.abs(offsetTop - scrollTop);

            delta = this.dir === 'down'? delta : -1 * delta;
            this.currentSection.domElem.css({
                top: delta
            });

        } else if (nextParams.fixed){
            height = this.currentSection.domElem.outerHeight();
            offsetTop = this.currentSection.domElem.offset().top;
            delta = height - Math.abs(offsetTop - scrollTop);

            delta = this.dir === 'up'? delta : -1 * delta;
            this.nextSection.domElem.css({
                top: delta
            });
        }
    ...
    _afterFPLoad : function (anchorLink, index) {
        this._lastDelta = null;
        this.emit('afterfpload', {
            anchorLink : anchorLink,
            index : index
        });
        //this.sections[index - 1].elem('go').animate({ opacity : 1})
        this.elem('go', 'name', this.sections[index - 1].name).animate({opacity : 1});
        if(!this.hasMod('is-ipad') && this.currentSection) {
            ...
            // this.unbindFromDoc('scroll', this._onParalaxScroll);
        }
        this.updateHeader(index);
    },

    _updateBackground : function() {
        var safeAndFriendlySection = this.findBlockInside({
            block : 'section',
            modName : 'name',
            modVal : 'safeAndFriendly'
        });
        var mainSection = this.findBlockInside({
            block : 'section',
            modName : 'type',
            modVal : 'summary-main'
        });
        var bigBackground = this.findElem(safeAndFriendlySection.domElem, 'big-background');

        bigBackground.css({
            top : -1 * mainSection.domElem.outerHeight() + 'px',
            height : mainSection.domElem.outerHeight() + safeAndFriendlySection.domElem.outerHeight() + 'px'
        });
    },

    _onScroll : function() {
        this._headers.forEach(function (item) {
            item.setMod('fixed', BEMDOM.doc.scrollTop() > this._offset);
        })
        //this._header
    },

    _offsetFirstSection : function() {
        var firstSection = this.findBlockInside('section');
        return firstSection.domElem.offset().top + firstSection.domElem.height();
    },

    updateHeader : function(index) {
        this._headers.forEach(function(item) {
            item.setMod('fixed', index > 1);
        });
    }
